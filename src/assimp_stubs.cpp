...
conversation with I made up {
  ...
  (Me) Assimp stubs.
  (MSVC) "Assimp stubs?"
  (MSVC) Who the FUCK is Assimp stubs?!
  (MSVC) I've never heard of Assimp stubs. Have you used it?
  (Me) No.
  (MSVC) Nobody uses a stub and keeps it.
  (MSVC) Was there such a demand that they put Stubs in the FUCKING Render Engine?!
  (MSVC) That's a conversation no one's ever had.
  (MSVC) Hey bro, what's your favorite placeholder?
  (MSVC) Oh, you know, it's Stub.
  (MSVC) Oh, mine too. Everybody loves Stub.
  (MSVC) Wanna make out?
  (MSVC) Sure.
  (MSVC) *imitation gay noises*
  (MSVC) I sure wish you were Stub, because apparently he's a fan FUCKING favorite.
  (Me) Look, compiler, just calm down.
